...
static async Task<JsonElement> SendMcpRequestAsync(HttpClient client, string method, object @params)
{
    var requestBody = new
    {
        jsonrpc = "2.0",
...
static string ExtractJsonFromSse(string ssePayload)
{
...
static string ExtractFirstTextContent(JsonElement callResult)
{
